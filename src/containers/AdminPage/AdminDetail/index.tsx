  ...
  return (
    <>
      <Box sx={headerStyle}>
        ...
        <Button variant="contained" color="primary" size="small">Nơi đã đi</Button>
        <Button variant="contained" color="primary" size="small" sx={{margin: "0 20px"}}>yêu cầu đã xác nhận</Button>
      </Box> */}
      </Box>
      <Box sx={{ flexGrow: 1, margin: '0 20px' }}>
        <Grid container spacing={2}>
          ...
          {/* <Grid item xs={5}>
          <Box sx={{display: "flex", justifyContent: "center"}}><h3>Yêu cầu xác nhận</h3></Box>
